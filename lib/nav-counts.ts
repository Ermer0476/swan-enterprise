...
export async function getNavCounts(
  ...
  const [incidents, nearMiss, ncr, defects, riskPending, meetingsWaiting, sireOpen, iauditOpen, eauditOpen, cinspOpen, pscOpen, cdiOpen, vesselDocs, warningMonths] = await Promise.all([
