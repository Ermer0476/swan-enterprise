...
export const vesselSchema = z.object({
  ...
  // Locked to a fixed list (not free text) so the Flag Drill Schedule
  // module can match a vessel to its flag's required drill set by exact
  // string equality — see lib/vessel-flags.ts.
  flag: z.enum(VESSEL_FLAGS).optional().or(z.literal("")),
