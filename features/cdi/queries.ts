...
export async function cdiAnalytics(companyId: string, range: { from?: Date; to?: Date }, vesselId?: string) {
...
/** Mirrors features/sire/queries.ts's listPersonnelOptions — Responsible
 * person / Verification by pickers on the observation form. */
