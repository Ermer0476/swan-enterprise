...
export async function eauditAnalytics(
  companyId: string,
  range: { from: Date; to: Date },
  vesselId?: string,
): Promise<EauditKpiData> {
...
// Flag State inspections now have their own dedicated module and model —
// see features/flag-inspections/queries.ts's flagInspectionAnalytics, which
// replaced this file's old "ExternalAudit whose auditBody names Flag"
// text-matching heuristic (the Dashboard now imports from there instead).
