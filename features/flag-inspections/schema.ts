...
// Flag Inspections KPI dashboard period selector — same 3-option convention
// as External Audit's KPI page, Rolling 12 Months default.
export const FLAGINSP_KPI_PERIODS = ["ROLLING_12", "YTD", "YEARLY"] as const;
export type FlaginspKpiPeriodKey = (typeof FLAGINSP_KPI_PERIODS)[number];
export const FLAGINSP_KPI_PERIOD_LABELS: Record<FlaginspKpiPeriodKey, string> = {
  ROLLING_12: "Rolling 12 Months",
  YTD: "YTD",
  YEARLY: "Yearly",
};
export const DEFAULT_FLAGINSP_KPI_PERIOD: FlaginspKpiPeriodKey = "ROLLING_12";

export const createFlagInspectionSchema = z.object({
...
// shared CapaAction tracker (entityType "FlagInspectionFinding"), not here.
