...
export default async function VesselDetailPage({
  ...
  const meta = [
    ...
    { label: "Standard F.O. Consumption (mt/day)", value: vessel.stdFoConsumptionMt ?? "—" },
    { label: "Standard D.O. Consumption (mt/day)", value: vessel.stdDoConsumptionMt ?? "—" },
      ...
      {canUpdate && (
        <VesselForm
          ...
          values={{
            ...
            archivedAt: vessel.archivedAt ? vessel.archivedAt.toISOString().slice(0, 10) : "",
            ...
            stdFoConsumptionMt: vessel.stdFoConsumptionMt?.toString() ?? "",
            stdDoConsumptionMt: vessel.stdDoConsumptionMt?.toString() ?? "",
