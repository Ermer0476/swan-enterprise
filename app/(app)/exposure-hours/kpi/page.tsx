...
export default async function ExposureKpiPage({
  ...
  // Shipboard sessions (including an Administrator's View-as-Vessel) are
  // always locked to their own vessel — the URL's vesselId is only trusted
  // for office sessions, which are free to compare any vessel or the fleet.
