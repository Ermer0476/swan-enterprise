...
import { CloneDocumentsForm } from "@/components/vessel-documents/clone-documents-form";
...
export default async function VesselDocumentationPage({
  ...
  return (
    <div className="mx-auto max-w-7xl">
      ...
      <Card className="p-4">
        {!isShipboard && canCreate && <CloneDocumentsForm vessels={vessels} currentVesselId={vesselId ?? undefined} />}
