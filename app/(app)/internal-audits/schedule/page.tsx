...
export default async function InternalAuditSchedulePage() {
  ...
  const rows = await listInternalAuditSchedule(user.companyId);
  ...
  return (
    <>
      ...
      <PageHeader
        ...
        description={`Fleet-wide next-audit matrix — ISM requires an internal audit of every vessel at least once every ${INTERNAL_AUDIT_SCHEDULE_MONTHS} months.`}
      />
