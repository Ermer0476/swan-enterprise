    ...
    <div className="space-y-3">
      <div className="flex flex-wrap items-center gap-2">
        {status !== "CLOSED" && canClose && (
          <Button onClick={() => run(closePscAction)} disabled={pending}>
        ...
        {canDelete && (
          <Button variant="outline"
            onClick={() => { if (confirm("Delete this inspection and all its deficiencies?")) run(deletePscAction); }}
            disabled={pending}>
