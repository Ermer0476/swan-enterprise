    ...
    <div className="mx-auto max-w-7xl">
      ...
      {isOwnDraft && (
        <div className="mb-6 flex justify-end">
          <ReportDraftButton nearMissId={nm.id} blocked={!allCapaClosed} />
        </div>
      )}
      ...
      <Card>
        ...
        <CardContent>
          <OfficeReviewForm
            ...
            shoreRemarksBy={nm.shoreRemarksByUser}
            shoreRemarksAt={nm.shoreRemarksAt ? nm.shoreRemarksAt.toISOString() : null}
