        ...
        <form action={formAction} className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="space-y-1.5">
              ...
              <AutoGrowInput id="departmentName" name="departmentName" defaultValue={ncr.departmentName} placeholder="e.g. QHSE Department" />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="reporterName">Reporter Name</Label>
              <AutoGrowInput id="reporterName" name="reporterName" defaultValue={ncr.reporterName} placeholder="Full name" />
            </div>
          </div>
