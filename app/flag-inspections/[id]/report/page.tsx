...
// Clean, fully read-only view of a Flag Inspection — for looking at "what the
...
export default async function FlagInspectionReportPage({
  params,
}: {
  ...
  const audit = await getFlagInspection(user.companyId, id);
  if (!audit) notFound();
  ...
  return (
    <div className="mx-auto max-w-4xl p-6">
      <div className="mb-4 flex items-center justify-between print:hidden">
        <Link
          href={`/flag-inspections/${audit.id}`}
